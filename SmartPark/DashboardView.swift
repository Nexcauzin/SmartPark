                        ...
                        VStack{
                            ...
                            VStack{
                                VStack{
                                    ...
                                    ZStack{
                                        ...
                                        ForEach(Array(arrayLiteral: viewModel.carros.sorted(by: {Int($0.last_arrival) ?? 0 > Int($1.last_arrival) ?? 0} ).first ?? Carro(_id: "", status: "", last_arrival: "", last_exit: "")), id: \.self) { d in
                            ...
                            VStack{
                                ...
                                ZStack{
                                    ...
                                    ForEach(Array(arrayLiteral: viewModel.carros.sorted(by: {Int($0.last_exit) ?? 0 > Int($1.last_exit) ?? 0} ).first ?? Carro(_id: "", status: "", last_arrival: "", last_exit: "")), id: \.self) { d in
